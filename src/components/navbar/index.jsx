    ...
    <>
      <Navbar variant="light" expand="lg" fixed="top">
        <div className="container-fluid">
                ...
                ? data.map((e, i) => {
                    if (e.dropDown) {
                      ...
                      return (
                        <a
                          href={e.href}
                          className="nav-link stact-nav-link anchor"
                          key={i}
                        >
                          {e.title}
                        </a>
                      ...
                      return (
                        <NavLink
                          to={e.href}
                          className="nav-link stact-nav-link"
                          key={i}
                        >
                          {e.title}
                        </NavLink>
          ...
          <a
            href="https://themeforest.net/item/stact-react-multipurpose-landing-page-template/37452814"
            target="_blank"
            rel="noreferrer"
